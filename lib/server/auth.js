...
// The one CRM account (hard-coded by request; override with env vars if needed).
export const ADMIN_USERNAME = process.env.CRM_ADMIN_USERNAME || "nickbrenton";
const ADMIN_PASSWORD = process.env.CRM_ADMIN_PASSWORD || "nickadmin";
