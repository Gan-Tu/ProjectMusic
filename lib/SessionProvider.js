...
export function SessionProvider({ children }) {
  ...
  // Every change is applied to the latest saved session (another tab may have saved
  // since this one last heard) and written right away, so edits made in two tabs
  // don't undo each other. Returns false when the browser won't store it (the
  // change still applies for this visit).
  ...
  // Profile edits report whether they were saved, so Settings can say so.
